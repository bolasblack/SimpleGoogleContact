import { Avatar, Tooltip, IconButton, ListItem, ListItemText, ListItemSecondaryAction } from '@material-ui/core'
import * as Icons from "@material-ui/icons"
import { ListItemProps } from '@material-ui/core/ListItem'
import { Person, PersonService } from '../../services/PersonService'

const DEFAULT_AVATAR = 'https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5Myp0nDj7fDykd0omFX4Aw9AIhgKABD___________8BGIzs_P3______wE/s160-p-k-rw-no/photo.jpg'
  ...
  return (
    <div className="ContactList__list-item" style={style}>
      <ListItem className="ContactList__list-item__inner" {...listItemProps}>
        ...
        <ListItemText style={listItemFieldsStyle} primary={PersonService.getPhoneNumber(person).value} />
        <ListItemText style={listItemFieldsStyle} primary={PersonService.getEmailAddress(person).value} />
